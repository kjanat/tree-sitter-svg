...
This parser is built against the SVG2 specification with reference to the SVG
1.1 DTD for element categorization. See [SPEC_AUDIT.md](SPEC_AUDIT.md) for
detailed evidence-to-implementation traceability.
